...
//    public virtual DbSet<TransactionNumberTracker> TransactionNumberTrackers { get; set; }
...
//        {
//            entity.HasKey(e => e.Id).HasName("PK__tblOTPs__3214EC0765E4B721");
...
//            entity.HasOne(d => d.User).WithMany(p => p.TblOtps)
//                .HasForeignKey(d => d.UserId)
//                .HasConstraintName("FK__tblOTPs__UserId__39E294A9");
//        });
...
//        modelBuilder.Entity<TransactionNumberTracker>(entity =>
//        {
//            entity.HasKey(e => e.DateKey).HasName("PK__Transact__40DF45E3FEB13B19");

//            entity.ToTable("TransactionNumberTracker");
